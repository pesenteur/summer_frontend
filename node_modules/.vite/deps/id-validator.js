...
// node_modules/id-validator/src/IDValidator.js
var require_IDValidator = __commonJS({
  "node_modules/id-validator/src/IDValidator.js"(exports, module) {
    (function(factory) {
      ...
      if (typeof define !== "undefined" && define.amd) {
        ...
        define(function(require2, exports2, module2) {
          module2.exports = factory(isWindow, global);
        });
      ...
      _IDValidator.prototype = {
        ...
        getInfo: function(id, forceType) {
          ...
          info.birth = code.type === 18 ? [birth.slice(0, 4), birth.slice(4, 6), birth.slice(-2)].join("-") : ["19" + birth.slice(0, 2), birth.slice(2, 4), birth.slice(-2)].join("-");
...
export default require_IDValidator();
